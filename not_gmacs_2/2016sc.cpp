...
{
  mean_log_rec_f.set_initial_value(13.1);
  mean_log_rec_m.set_initial_value(13.1);
  log_avg_fmort.set_initial_value(-1.0);
  log_avg_fmortt.set_initial_value(-7.0);
  log_avg_sel50_mn.set_initial_value(4.4427);
  fmort_dev.set_initial_value(0.00001);
  moltp_af.set_initial_value(2.0);
  moltp_bf.set_initial_value(150.);
  moltp_am.set_initial_value(0.02);
  moltp_bm.set_initial_value(300.);
  moltp_ammat.set_initial_value(0.05);
  moltp_bmmat.set_initial_value(105.0);
  srv1_q.set_initial_value(1.0);
  srv2_q.set_initial_value(1.0);
  srv3_q.set_initial_value(1.0);
  srv1_sel95.set_initial_value(60);
  srv1_sel50.set_initial_value(40);
  fish_fit_sel50_mn.set_initial_value(95.1);
  fish_fit_sel50_mo.set_initial_value(100.0);
  log_sel50_dev_mn.set_initial_value(0.0000);
  discard_mult.set_initial_value(1.0);
  mateste.set_initial_value(-0.7);
  matestfe.set_initial_value(-0.7);
  cpueq.set_initial_value(0.001);
  fish_disc_sel50_f.set_initial_value(4.2);
  af.set_initial_value(-5);
  am.set_initial_value(-5);
  bf.set_initial_value(1.5);
  bm.set_initial_value(1.5);
  b1.set_initial_value(1.1);
  bf1.set_initial_value(1);
  deltam.set_initial_value(32);
  deltaf.set_initial_value(34);
}
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  b1.allocate(1.0,1.5,growth_phase2,"b1");
  bf1.allocate(1.0,2.0,growth_phase2,"bf1");
  deltam.allocate(10.0,50.0,growth_phase2,"deltam");
  deltaf.allocate(5.0,50.0,growth_phase2,"deltaf");
  st_gr.allocate(0.5,0.5,-growth_phase2,"st_gr");
