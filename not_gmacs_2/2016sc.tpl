...
PARAMETER_SECTION
 //growth pars
  init_bounded_number af(-100,10.0,growth_phase)
  init_bounded_number am(-50.0,10.0,growth_phase)
 ...
 //Maturity parameters
  ...
  init_bounded_number moltp_bmmat(1,120,phase_moltingp)  				   //logistic molting prob for mature males
    ...
    init_number mean_log_rec_f
	init_number mean_log_rec_m(sep_rec_dev)
    init_bounded_dev_vector rec_devf(styr,endyr,-15,15,rec_phase)
    init_bounded_dev_vector rec_devm(styr,endyr,-15,15,sep_rec_dev*rec_phase)
 ...
 // three survey eras:
  ...
  //industry
   ...
   init_bounded_number srvind_sel95_f(5.0,120.0,survsel1_phase)
   init_bounded_number srvind_sel50_f(1.0,110.0,survsel1_phase)
